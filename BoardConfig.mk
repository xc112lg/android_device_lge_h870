...
# Assert
TARGET_OTA_ASSERT_DEVICE := h870

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 26685440 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_SOURCE := kernel/lge/h870
TARGET_KERNEL_CONFIG := h870_defconfig
